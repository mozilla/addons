...
## After we're done:
* `./manage.py process_addons --task=repack_themes_for_69` to catch a few stragglers that submitted themes using legacy properties since we ran this previously.
