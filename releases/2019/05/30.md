...
* In `addons-code-manager`, set `REACT_APP_UNSAFE_ERROR_SIMULATION` to `"true"` ([example](https://github.com/mozilla-services/cloudops-deployment/pull/3190/files)) and ask Kumar to test it. If it works, remove the environment variable.
