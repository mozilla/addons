# -*- coding: utf-8 -*-
#
# Add-ons documentation build configuration file, created by
# sphinx-quickstart on Tue Sep  8 13:59:15 2015.
#
...
latex_documents = [
  (master_doc, 'Add-ons.tex', u'Add-ons Documentation',
   u'Mozilla', 'manual'),
]
...
man_pages = [
    (master_doc, 'add-ons', u'Add-ons Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Add-ons', u'Add-ons Documentation',
   author, 'Add-ons', 'One line description of project.',
   'Miscellaneous'),
]
